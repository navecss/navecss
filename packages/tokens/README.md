...
| `@navecss/tokens/js`            | Typed ESM token constants — the DTCG 2025.10 token set; every `--nave-color-*` custom property (the `--nave-color-tint` seed included) ships as a value in the stylesheet above and not through this export, but its NAME is typed here as `ColorPropertyName`, exported alongside `TokenName`/`TokenValue` and disjoint from them                                                                                                                                                                                                                                                                                                                                                      |
