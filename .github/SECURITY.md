...
problem private until that advisory is published. If the report is not accepted
as a vulnerability, it is closed and the problem can go to a public issue like
any other bug.
